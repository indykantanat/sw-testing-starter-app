...
const FeaturesCourse = ({ courses, errorMessage = null }: Props) => {
  return (
      ...
      <div className="w-full grow sm:max-w-(--breakpoint-md) lg:max-w-(--breakpoint-lg)">
        ...
        {errorMessage ? (
          <p
            ...
            className="mt-16 text-center text-destructive"
          >
            {errorMessage}
          </p>
        ) : courses.length === 0 ? (
          <p
            ...
            className="mt-16 text-center text-foreground/70"
          >
          ...
          <div
            ...
            className="mt-18 grid w-full gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-3"
          >
            {courses.map((course) => (
              <div
